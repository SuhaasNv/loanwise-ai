"""Mock data for local development — matches frontend src/lib/mock-data.ts"""
...
DASHBOARD_STATS = {"totalApplications": 47, "approvalRate": 68.3, "avgRiskScore": 0.34, "activeAgents": 4}
