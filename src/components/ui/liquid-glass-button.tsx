    ...
    <>
      ...
      >
        <div className="absolute top-0 left-0 z-0 h-full w-full rounded-full 
            shadow-[inset_0_1px_1px_rgba(255,255,255,0.3),inset_0_-1px_1px_rgba(0,0,0,0.5),0_0_15px_rgba(6,182,212,0.3)] bg-cyan-500/10 border border-cyan-400/30
        transition-all group-hover:bg-cyan-500/20 group-hover:shadow-[inset_0_1px_1px_rgba(255,255,255,0.4),inset_0_-1px_1px_rgba(0,0,0,0.5),0_0_20px_rgba(6,182,212,0.5)]" />
        <div
          className="absolute top-0 left-0 isolate -z-10 h-full w-full overflow-hidden rounded-md"
          style={{ backdropFilter: 'url("#container-glass") blur(4px)' }}
        />

        <div className="pointer-events-none z-10 flex flex-row items-center justify-center gap-2">
          {children}
        </div>
        <GlassFilter />
      </Comp>
...
> = {
  ...
  cyan: {
    outer: "bg-gradient-to-b from-[#06b6d4] to-[#0891b2]",
    inner: "bg-gradient-to-b from-[#cffafe] via-[#06b6d4] to-[#22d3ee]",
    button: "bg-gradient-to-b from-[#67e8f9] to-[#0891b2]",
    textColor: "text-cyan-950",
    textShadow: "none",
  },
  darkOutline: {
    outer: "bg-gradient-to-b from-slate-600 to-slate-900",
    inner: "bg-slate-900 border border-white/5",
    button: "bg-transparent hover:bg-white/5 text-slate-200",
...
const metalButtonVariants = (
  ...
  return {
    ...
    button: cn(
      "relative m-[1px] rounded-[calc(0.375rem-2px)] inline-flex min-h-11 transform-gpu cursor-pointer items-center justify-center overflow-hidden px-6 py-2 text-sm leading-none font-semibold will-change-transform outline-none",
      colors.button,
      colors.textColor,
      colors.textShadow,
    ),
